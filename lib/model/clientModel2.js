...
Client.prototype._waitResult = function(taskID, callback) {
    ...
    function _tryToRead(deadline) {
        ...
        let dataOnce = this._socket.read();
        if(!dataOnce) return setTimeout(_tryToRead.bind(this, deadlineTimes--), READ_INTERVAL_TIME);
        dataCache += dataOnce;
        console.log('>> dataCache:', dataCache);
        let realData = dataCache.match(resultPattern);
